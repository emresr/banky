        ...
        <div className="px-5 w-full fixed h-12 bg-white border-grey-lightest border-b flex items-center">
          <div className="container mx-auto flex">
            <div className="w-3/5 flex">
              <div className="">
                <a href="#" className="w-auto inline-flex items-center h-full">
                  ...
                  <svg
                    className="h-5 ml-2 hidden xl:flex"
              ...
              <div className="ml-5">
                <div className="w-68 h-full border border-white hover:border-grey-lightest flex items-center rounded px-10 relative">
                  <svg
                    className="w-5 absolute pin-l ml-2 fill-current text-blue-dark"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g>
                  ...
                  <svg
                    className="w-6 absolute pin-r mr-2"
                    viewBox="0 0 20 20"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g>
              ...
              <div className="w-full mx-5">
                <div className="flex items-center w-auto h-full pl-8 pr-2 border border-grey-lightest hover:border-blue rounded relative">
                  <svg
                    className="w-4 absolute pin-l ml-2 fill-current text-grey-dark"
                    viewBox="0 0 16 16"
                    version="1.1"
                    xmlns="http://www.w3.org/2000/svg"
                  >
            ...
            <div className="w-2/5 flex justify-end items-center">
              ...
              <a
                href="#"
                className="border border-blue-dark text-blue-dark px-8 py-2.2 font-semibold text-xs rounded ml-4 no-underline hover:border-blue hover:text-blue"
              >
                LOG IN
              </a>
              <a
              ...
              <button className="inline-flex items-center ml-3 mr-5">
                <div className="flex items-center pr-2">
                  <svg
                    className="w-6 fill-current text-grey-dark"
                    viewBox="0 0 250 250"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g fill="inherit">
